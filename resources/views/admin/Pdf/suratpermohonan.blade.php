        ...
        <table align="center">
            ...
            <tr>
                ...
                <td width="250" align="justify">Kepada Yth. Pimpinan
                    <br>
                    <b>CV. Media Pratama Solusinet</b>
                    <br>
                    Jl. Hanoman Ruko Pondok Asri, Griya Mejasem Baru 4, Griya Mejasem Baru, Mejasem Bar., Kec. Kramat,
                ...
                <td colspan="4" align="justify" width="300" style="margin-bottom: 0px">Dengan hormat,
                    <div class="isi">
                        <p style="text-indent: 30px; text-align: justify; margin-top: 5px; margin-bottom:0px">Bersama
                            ...
                            <b>CV. Media Pratama Solusinet</b> untuk menerima siswa kami
    ...
    <section class="page2">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <td width="10"> :</td>
                <td width="520"> Adiwerna, 28 Agustus 2023</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <center>
                        ...
                        <font size="3"><b>“CV. Media Pratama Solusinet”</b></font><br>
                        <font size="3"><b>PROGRAM KEAHLIAN TEKNIK JARINGAN KOMPUTER DAN</b></font><br>
                        <font size="3"><b>TELEKOMUNIKASI (TJKT) SMKN 1 ADIWERNA</b></font><br>
        ...
        <table border="1" align="center">
            ...
            <tbody>
                <tr>
                    ...
                    <td width="90" style="text-align: center;">21.19475</td>
                    <td width="210" style="text-align: center;">DAHLIA</td>
                    <td width="90" style="text-align: center;">TJKT-3</td>
                    <td width="140" style="text-align: center;">0895360993730</td>
            </tbody>
        </table>
        <br>
        <table align="center">
            ...
            <tr>
                <td colspan="3" width="200">
                    <p style="text-indent: 30px; text-align: justify; margin:0px; line-height: 1.5;">
                        ...
                        nomor ajuan 423.4 /....../ 2022 tanggal 28 Agustus 2023. Maka dengan ini kami
                        <b>MENERIMA / MENOLAK * </b>untuk melaksanakan kegiatan tersebut sesuai dengan syarat dan
                        ketentuan yang berlaku di Perusahaan/Instansi <b>CV. Media Pratama Solusinet</b> yang beralamat
                        di Jl. Hanoman Ruko Pondok Asri, Griya Mejasem Baru 4, Griya Mejasem Baru, Mejasem Bar.,
                        Kec. Kramat, Kabupaten Tegal, Jawa Tengah 52181, selama …… bulan dan terhitung mulai
                        ........................ sampai ........................
                    </p>
                    <p style="text-indent: 30px; text-align: justify; margin:0px; line-height: 1.5">
        ...
        <table border="1" align="center">
            ...
            <tbody>
                <tr>
                    <td width="40" style="text-align: center;">1</td>
                    <td width="90" style="text-align: center;">21.19475</td>
                    <td width="275" style="text-align: center;">DAHLIA</td>
                ...
                <td>
                    <div class="ttd">
                        ...
                        <ul style="list-style-type: none; margin: 0;">
                            <li>................., ........................... 20......</li>
                            <li>an. <b>CV. Media Pratama Solusinet</b></li>
                            <br>
                            <br>
                            <br>
                            <br>
