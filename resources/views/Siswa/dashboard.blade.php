                                ...
                                <div class="col-6">
                                    <div class="text-end">
                                        ...
                                        <a style="color: #000000; text-decoration: none;"
                                            href="{{ route('siswa.pengaturan') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="justify-content: center; align-items:center; text-align:center; margin-right:5px" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
